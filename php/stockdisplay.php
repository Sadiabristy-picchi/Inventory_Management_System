...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
        <a class="nav-link active" href="../php/stockdisplay.php">Stock</a>
      </li>
      <li class="nav-item">
  ...
  <a href="../html/addstock.html" class="text-light">Add Product</a>
  </button>
  <table class="table">
  <thead>
    <tr>
  ...
  <tbody>
    ...
    { 
        ...
        {     
            ...
            <a href="update.php? updateid='.$itemid.'" class="text-light">update</a>
            </button>
            <button  class="btn btn-danger" >
            <a href="delete.php? deleteid='.$itemid.'" class="text-light">delete</a>
            </button>
            </td>
            </tr>';
        }
